        ...
        if (t.kind == TokenKind.Identifier) {
            ...
            if (t1.text == '(') {
                ...
                if (t2.text == ')') {
                    ...
                    console.log("Expection ')' in FunctionDecl, while we got a " + t.text)
                    return null
                }
            } else {
    ...
    parseFunctionBody(): FunctionBody | null | void {
        ...
        if (t.text == '{') {
            ...
            if (t.text == '}') {
                ...
                console.log("Excepting '}' in FunctionBody, while we got a " + t.text)
                return null
            }
        } else {
                ...
                while (t2.text != ")") {
                    ...
                    if (t2.text != ")") {
                        if (t2.text == ",") {
                            ...
                            console.log("Expecting a comma in FunctionCall, ")
                        }
                    }
                }
...
function compileAndRun(program: string) {
    ...
    tokenizer = new Tokenizer(new CharStream(program)) // 重置，回到开头
